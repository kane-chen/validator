...
public class PeriodEntries<T extends Timestamp> implements Iterable<List<T>> {
  ...
  public static <T extends Timestamp> PeriodEntries<T> create(Iterable<List<T>> entriesIt, long interval) {
  ...
  public Iterator<List<T>> iterator() {
    return new Iterator<List<T>>() {
      ...
      private long normalizeInterval(T entry) {
        long time = ((Timestamp)entry).getTime();
